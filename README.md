# LLM Personalization
> 受不了跟 ChatGPT 對話，查詢資料時總是回覆，我「命中」你、「不跟你繞」、「最直接的跟你說」這些東西嗎？
> 如果你也喜歡比較文學式的回覆，在工作中想得到最純粹的內容，想避免 ChatGPT 在試圖一直 👉👉👉「接住」你，並用大量無關必要的 Emoji？
> 你好，同路人，請別錯過這個專案

對於習慣嚴肅閱讀與長期保存內容的使用者而言，  
有時候 LLM，往往被調教的過於熱絡、直白，甚至帶有不必要的自我表述。

本專案用來整理一組可重複使用的 LLM personalization 設定，
你可以根據自己的喜好來選擇對應的 Config 並放入你的 LLM 語氣風格設定中。
